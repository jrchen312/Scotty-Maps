...
from maps.models import *
hh = Location.objects.get(id=2)
roberts_3 = Floor(location=hh, name="Roberts 3", img_path="roberts3.png", graph_path="roberts3_graph.json", 
                  x_pixel_scale=660-143, y_pixel_scale=320-157, x_pixel_offset=143, y_pixel_offset=157,
...
wiegand_floor = Floor(location=wiegand, name="Wiegand Gym", img_path="wiegandv1.png", graph_path="wiegand_small_v1.json", 
                x_pixel_scale=1460-274, y_pixel_scale=1057-101, 
                x_pixel_offset=274, y_pixel_offset=101,
